  ...
  return (
    ...
    >
      ...
      <div className="mt-8 flex flex-wrap justify-center">
        {isSignedIn ? <a
          className="block w-full rounded bg-primary px-12 py-3 text-sm font-medium text-white shadow hover:bg-red-900 focus:outline-none focus:ring active:bg-red-00 sm:w-auto"
          href="/dashboard"
